...
export class ProviderHistoryComponent implements OnInit {
  ...
  displayColumns = ['Sno', 'Provider ID', 'Getter ID', 'Provider Amt', 'Provider Date', 'Transaction ID', 'Transaction Date', 'Status'];
  ...
  constructor(private provideHistoryService: ProviderHistoryService) {
    this.provideHistoryService.getAllProviderHistory().subscribe(
    providerHistory => {
